...
<button class="btnPrint" style="width:150px; background-color:#FF0000"  generic="Manuel_User" data-title="MoleMate- Molecule Spectra - User Manual" onclick="PRINTbnt(event)">🖶 Print</button>
                    ...
                    <h1>MoleMate- Molecule Spectra - User Manual</h1>
                ...
                <div id="manualContent" class="manual-content">
                    ...
                    <h2>🔍 Select the organic compound</h2>

                    <p><strong>Enter a compound:</strong> You can search by CID number, compound name, or SMILES notation.<br>
		    <strong>Press</strong> <kbd>Enter</kbd> after typing to search automatically<br>
-------------------or-------------------<br> 
                    <strong>Import a file:</strong> Click "Import .mol file" to load molecular data from a .mol or .sdf file.</p>

                    <h2>✅ Information on the left panel</h2>

<p><strong>MoleMate- Molecule Spectra </strong> responses :Name - IUPAC Name - CAS Number - Molecular Formula - Molecular Weight - Lipophilicity - H bonding - 
H-Bond Donor - Bond Acceptors - Rotatable Bonds- Complexity & Electric Charge	</p>

                    
                    <h2>📊 Available and Simulated Spectra on the right panel</h2>
 
                        <p><strong>Spectrum:</strong> Overview of available real spectroscopic data on the web (if any)<br>
                         <strong>RMN H1:</strong> Simulated Proton Nuclear Magnetic Resonance<br>
                        <strong>RMN C13:</strong> Simulated Carbon-13 Nuclear Magnetic Resonance<br>
                        <strong>IR:</strong>Simulated Infrared Spectroscopy<br>
                        <strong>Mass Spectrum:</strong>Simulated  Mass Spectrometry data<br>
                        <strong>HAZARD:</strong> Existing safety information and hazard classification</p>

                    <p>Watch out : it is <strong><u>simulated spectra</u></strong>. Click on any spectrum tab to view detailed analysis</p>
                </div>
            </div>
        </div>
    `;
